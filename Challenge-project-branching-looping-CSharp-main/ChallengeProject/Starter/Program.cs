...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets && ourAnimals[i, 0] != "ID #: "; i++)
            {
                // get the pet's age. can be ? at initial entry.
                ...
                do
                {
                    ...
                    {
                        animalAge = readResult;
                        if (int.TryParse(animalAge, out petAge) == true)
                        {
                            validEntry = int.TryParse(animalAge, out petAge);
                        }
                        else
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets && ourAnimals[i, 0] != "ID #: "; i++)
            {
                // get a description of the pet's nickname - cannot be blank.
                ...
                // get a description of the pet's personality - cannot be blank.
